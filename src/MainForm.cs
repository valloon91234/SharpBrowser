...
namespace SharpBrowser
{
    ...
    internal partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            if (args.Length > 1)
            {
                BrowserConfig.HomepageURL = args[1];
                if (args.Length > 2)
                    BrowserConfig.ProxyURL = args[2];
            }
        ...
        private void InitBrowser()
        {
            ...
            //}
            if (BrowserConfig.ProxyURL != null)
                settings.CefCommandLineArgs.Add("proxy-server", BrowserConfig.ProxyURL);
        ...
        private void Browser_URLChanged(object sender, AddressChangedEventArgs e)
        {
            InvokeIfNeeded(() =>
            {
                ...
                if (sender == CurBrowser)
                {
                    ...
                    SetTabTitle((ChromiumWebBrowser)sender, e.Address);
